        ...
        <div class="col-md-8 mx-auto">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 text-dark">
                    <i class="fas fa-edit text-warning me-2"></i>Edit Buku
                </h1>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <h5 class="card-title mb-0 text-dark fw-semibold">
                        <i class="fas fa-book me-2"></i>Form Edit Data Buku
                    </h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kategori') is-invalid @enderror" 
                                    ...
                                    <option value="Bisnis" {{ old('kategori', $buku->kategori) == 'Bisnis' ? 'selected' : '' }}>Bisnis</option>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                          ...
                                          name="deskripsi" 
                                          rows="4"
                                          placeholder="Deskripsi singkat tentang buku (opsional)">{{ old('deskripsi', $buku->deskripsi ?? '') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
